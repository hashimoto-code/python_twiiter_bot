...
CONSUMER_KEY = CONFIG["CONSUMER_KEY"]#"Er64oV1H5GrURXvRq7w2Xq6ir"
CONSUMER_SECRET = CONFIG["CONSUMER_SECRET"]#"jEK8dVMwq32E0UYiHZCLoQjn7vnruacOKtzVo65VgqQCotIddc"
ACCESS_TOKEN = CONFIG["ACCESS_TOKEN"]#"3254740214-y1UqPSGA8dJsfIaN3ljkS8BRtOfE0ogbBFZJ9TU"
ACCESS_SECRET = CONFIG["ACCESS_SECRET"]#"tbAUL5GR77c1YBSr5Rev49iYa19A7qMv7h7zAle2wuLvy"
...
def main():
    ...
    search_results = api.search(q="フォートナイト", count=100) #ツイートワード検索 除外されるものも含めて100件検索
